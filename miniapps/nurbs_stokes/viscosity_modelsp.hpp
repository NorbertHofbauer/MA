...
{
protected:
   mfem::ParGridFunction *u; // displacement
...
public:
   ...
   void SetVelocity(mfem::ParGridFunction &u_) { u = &u_; }
...
protected:
   mfem::ParGridFunction *u; // displacement
   mfem::ParGridFunction *t; // temperature
...
public:
   ...
   void SetVelocity(mfem::ParGridFunction &u_) { u = &u_; }
   void SetTemperature(mfem::ParGridFunction &t_) { t = &t_; }
