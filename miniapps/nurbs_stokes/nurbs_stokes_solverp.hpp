#ifndef NURBSSTOKESSOLVERP_HPP
#define NURBSSTOKESSOLVERP_HPP
//                          MFEM - NURBS Version
//
...
#include "viscosity_modelsp.hpp" // include our shear rate models
...
public:
   ...
   mfem::ParMesh *pmesh; // mfem parallel mesh object
   ...
   mfem::ParFiniteElementSpace *tfes;  // temperature finite element space, with dimension 1 (scalar field)
   ...
   bool calc_dirichletbc(mfem::ParGridFunction &v0, mfem::ParGridFunction &p0, mfem::ParGridFunction &t0); // calculate our gridfunction on the dirchlet bc
   
   bool calc_flowsystem_strongbc(mfem::ParGridFunction &v0, mfem::ParGridFunction &p0, mfem::ParGridFunction &t0, mfem::ParGridFunction &v, mfem::ParGridFunction &p, mfem::ParGridFunction &t, mfem::Coefficient &kin_vis); // assemble and compute our system matrices with strong boundary conditions
   
   bool calc_temperaturesystem_strongbc(mfem::ParGridFunction &v0, mfem::ParGridFunction &t0, mfem::ParGridFunction &v, mfem::ParGridFunction &t); // assemble and compute our system matrices with strong boundary conditions

   bool solve_flow(mfem::ParGridFunction &v0, mfem::ParGridFunction &p0, mfem::ParGridFunction &t0, mfem::ParGridFunction &v, mfem::ParGridFunction &p, mfem::ParGridFunction &t,mfem::Coefficient &kin_vis);
   bool solve_temperature(mfem::ParGridFunction &v0, mfem::ParGridFunction &t0, mfem::ParGridFunction &v, mfem::ParGridFunction &t);
};


#endif // NURBSSTOKESSOLVERP_HPP
