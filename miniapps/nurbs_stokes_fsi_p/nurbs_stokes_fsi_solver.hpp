...
public:
   ...
   mfem::ParMesh *pmesh_fluid;  // mfem parallel mesh object
   mfem::ParMesh *pmesh_solid;  // mfem parallel mesh object
   int sdim;                        // dimension in space from the mesh 1D, 2D, 3D
   int ref_levels;                  // mesh refinement levels
   int par_ref_levels;                  // mesh refinement levels
   ...
   mfem::ParFiniteElementSpace *vfes; // velocity finite element space, with dimension sdim
   mfem::ParFiniteElementSpace *pfes;  // pressure finite element space, with dimension 1 (scalar field)
   mfem::ParFiniteElementSpace *tffes;  // temperature fluid finite element space, with dimension 1 (scalar field)
   mfem::ParFiniteElementSpace *tsfes;  // temperature fluid finite element space, with dimension 1 (scalar field)
   ...
   bool calc_dirichletbc_fluid(mfem::ParGridFunction &v0, mfem::ParGridFunction &p0, mfem::ParGridFunction &tf0); // calculate our gridfunction on the dirchlet bc
   bool calc_dirichletbc_fluid_cht(mfem::ParGridFunction &tf0,mfem::ParGridFunction &ts0); // calculate our gridfunction on the dirchlet bc
   bool calc_dirichletbc_solid(mfem::ParGridFunction &ts0); // calculate our gridfunction on the dirchlet bc
   
   bool calc_flowsystem_strongbc(mfem::ParGridFunction &v0, mfem::ParGridFunction &p0, mfem::ParGridFunction &tf0, mfem::ParGridFunction &v, mfem::ParGridFunction &p, mfem::ParGridFunction &tf, mfem::Coefficient &kin_vis); // assemble and compute our system matrices with strong boundary conditions
   
   bool calc_temperaturesystem_strongbc_fluid(mfem::ParGridFunction &v0, mfem::ParGridFunction &tf0,mfem::ParGridFunction &ts0, mfem::ParGridFunction &v, mfem::ParGridFunction &tf, mfem::ParGridFunction &ts); // assemble and compute our system matrices with strong boundary conditions
   bool calc_temperaturesystem_strongbc_solid(mfem::ParGridFunction &tf0, mfem::ParGridFunction &ts0,mfem::ParGridFunction &tf, mfem::ParGridFunction &ts, std::vector<double> &flux); // assemble and compute our system matrices with strong boundary conditions
   bool calc_temperaturesystem_strongbc_solid_init(mfem::ParGridFunction &tf0, mfem::ParGridFunction &ts0,mfem::ParGridFunction &tf, mfem::ParGridFunction &ts); // assemble and compute our system matrices with strong boundary conditions

   bool solve_flow(mfem::ParGridFunction &v0, mfem::ParGridFunction &p0, mfem::ParGridFunction &tf0, mfem::ParGridFunction &v, mfem::ParGridFunction &p, mfem::ParGridFunction &tf,mfem::Coefficient &kin_vis);
   bool solve_temperature(mfem::ParGridFunction &v0, mfem::ParGridFunction &tf0, mfem::ParGridFunction &ts0, mfem::ParGridFunction &v, mfem::ParGridFunction &tf, mfem::ParGridFunction &ts, std::vector<double> &flux);
};
