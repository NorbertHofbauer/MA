...
protected:
   ...
   Array<Array<int>*> boundary_trace_face_integs_marker;
    ...
    /// Set of interior face integrators.  //Norbert
   Array<BilinearFormIntegrator*> interior_face_integs;  //Norbert
   /// Set of boundary face Integrators to be applied. //Norbert
   Array<BilinearFormIntegrator*> boundary_face_integs; //Norbert
   Array<Array<int>*> boundary_face_integs_marker; ///< Entries are not owned.//Norbert
...
public:
   ...
   /// Adds new interior Face Integrator. Assumes ownership of @a bfi. //Norbert begin
   void AddInteriorFaceIntegrator(BilinearFormIntegrator *bfi);
   ...
   /** @brief Adds new boundary Face Integrator, restricted to specific boundary
       ...
       as a pointer to the given Array<int> object. */
   void AddBdrFaceIntegrator(BilinearFormIntegrator *bfi,
                             Array<int> &bdr_marker);  // Norbert end
   ...
   { return &boundary_trace_face_integs_marker; }
      ...
      /// Access all integrators added with AddInteriorFaceIntegrator().   //Norbert begin
   Array<BilinearFormIntegrator*> *GetFBFI() { return &interior_face_integs; }
   ...
   /** @brief Access all boundary markers added with AddBdrFaceIntegrator().
       ...
       corresponding pointer (to Array<int>) will be NULL. */
   Array<Array<int>*> *GetBFBFI_Marker()
   { return &boundary_face_integs_marker; }     //Norbert end
